...
function ContextStrip() {
  const items = [
    ...
    [Coins, 'Evidence', 'Simulated / Derived'], [ShieldCheck, 'Currency', 'VND bn'], [Clock3, 'Historical OOS', 'PASS'],
  ] as const;
