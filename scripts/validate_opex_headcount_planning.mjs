...
const [dataPath="data/opex_headcount_planning_synthetic.csv",sourceReportPath="docs/OPEX_HEADCOUNT_PLANNING_MODULE.md",qaOutputPath="reports/OPEX_HEADCOUNT_PLANNING_QA.md"]=process.argv.slice(2);
...
add("Report governance detail",/owner/i.test(report)&&/guardrail/i.test(report)&&report.includes("Release boundary"),"missing governance text");
