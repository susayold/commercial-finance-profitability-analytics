...
const measureNames=["Net Revenue","Gross Profit","Contribution Margin","Contribution Margin %","Budget Revenue","Revenue Variance","Forecast Revenue","DSO","DIO","DPO","CCC","Promotion ROI","Below Hurdle Flag","Selected Scenario","Approved Peer Rows","Peer Evidence Coverage","OPEX Actual","OPEX Budget","OPEX Forecast","OPEX Budget Variance","OPEX Forecast Variance","Headcount Close","Average Headcount","Payroll Cost","OPEX per FTE"];
