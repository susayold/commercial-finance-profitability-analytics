...
const measureNames=["Net Revenue","Gross Profit","Contribution Margin","Contribution Margin %","Budget Revenue","Revenue Variance","Forecast Revenue","DSO","DIO","DPO","CCC","Promotion ROI","Below Hurdle Flag","Selected Scenario","Approved Peer Rows","Peer Evidence Coverage","OPEX Actual","OPEX Budget","OPEX Forecast","OPEX Budget Variance","OPEX Forecast Variance","Headcount Close","Average Headcount","Payroll Cost","OPEX per FTE","CAPEX Actual","CAPEX Budget","CAPEX Forecast","CAPEX Committed","CAPEX Cash Payment","CAPEX Budget Variance","CAPEX Forecast Variance","Depreciation","Expected Annual Contribution","CAPEX Payback Months"];
