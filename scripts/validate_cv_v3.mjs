...
check('external_gate_boundary', cv.includes('internal forecast accuracy') && cv.includes('native Power BI') && cv.includes('realised business impact'), 'unsupported live claims explicitly blocked');
