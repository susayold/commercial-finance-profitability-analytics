...
MEASURES = [
    ...
    ("COGS", "SUM ( Sales[cogs] )", "#,0,,.0 M"),
    ("Gross Profit", "[Net Revenue] - [COGS]", "#,0,,.0 M"),
    ...
    ("Units", "SUM ( Sales[units] )", "#,0"),
    ("ASP", "DIVIDE ( [Net Revenue], [Units] )", "#,0"),
    ...
    ("Prior Units", "CALCULATE ( [Units], DATEADD ( Calendar[month], -1, MONTH ) )", "#,0"),
    ("Prior ASP", "CALCULATE ( [ASP], DATEADD ( Calendar[month], -1, MONTH ) )", "#,0"),
    ("Price Impact", "( [ASP] - [Prior ASP] ) * [Units]", "#,0,,.0 M;(#,0,,.0 M)"),
    ("Volume Impact", "( [Units] - [Prior Units] ) * [Prior ASP]", "#,0,,.0 M;(#,0,,.0 M)"),
    ...
    page_specs = [
        ...
        ("PVM Bridge", [
            ...
            table_visual("30000000000000000007", 40, 450, 7,
                         ...
                         ["Units", "ASP", "Price Impact", "Volume Impact", "Mix Other Impact"]),
        ]),
