...
add('RI-02', 'Canonical release name', identity.release_name === 'VNFINANCE-FPA-v1.0', identity.release_name);
...
add('RI-04', 'Release tag/SHA are stable and gated', identity.release_status === 'RECRUITER_READY_WITH_OPEN_EXTERNAL_CLAIM_GATES' && identity.release_tag === 'fpa-portfolio-v1.0' && identity.release_source_sha, `tag=${identity.release_tag ?? 'null'}; source=${identity.release_source_sha ?? 'null'}`);
