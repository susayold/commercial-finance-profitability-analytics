...
writeCsv(path.join(ACCT, 'gl_management_mapping.csv'), accounts.map(row => ({ ...row, management_line: row.account_name, cost_center_rule: row.account_type === 'Expense' ? 'Function/CostCenter from source ledger' : 'Company', mapping_status: 'APPROVED_SIMULATED' })), [...Object.keys(accounts[0]), 'management_line', 'cost_center_rule', 'mapping_status']);
