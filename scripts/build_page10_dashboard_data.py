...
output = {
    ...
    "cash": cash,
    "costResource": {
        "costVariance": round(costing["fy2025"]["totalVarianceVnd"] / 1_000_000, 1),
        "materialShare": round(costing["fy2025"]["materialSharePct"], 1),
        "opexQ4Q1": resources.get("opexQ4Q1Pct", 26.3),
        "nonPayrollShare": resources.get("nonPayrollSharePct", 15.9),
    ...
    "sources": {
        ...
        "costing": {"source_page": "Page 5", "source_file": "site/data/generated/page5-costing.json", "evidence_class": "SIMULATED/DERIVED"},
