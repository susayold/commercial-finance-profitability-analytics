...
commercial = {
    ...
    "negative": sum(1 for row in promotions if row["incrementalContribution"] < 0),
    "belowHurdle": sum(1 for row in page3["channels"] if row["cm"] < page3["canonical"]["hurdle"]),
...
output = {
    ...
    "costResource": {
        ...
        "capexProject": resources.get("capexProject", "P-006 Energy Retrofit"),
        "capexStatus": resources.get("capexStatus", "PENDING / REVIEW"),
        "capexEnvelope": resources["capexEnvelopeBn"],
        "capexPayback": resources.get("capexPaybackMonths", 22),
    },
    "plan": plan,
    "controls": [
        ...
        {"label": "Gate A", "value": page9["gateA"], "status": page9["gateA"]},
        {"label": "Power BI", "value": page9["powerBi"], "status": "OUT"},
    ],
