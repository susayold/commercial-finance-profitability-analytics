...
- Production site: [Sites v25 recruiter portfolio](https://vn-finance-fpa-case.sangkenny200.chatgpt.site/#contact)
...
- **Final plan-aligned build:** [editable PBIP](powerbi/final/VNFinance_Commercial_Finance_FINAL/VNFinance_Commercial_Finance_FINAL.pbip) · [editable PBIT](powerbi/releases/VNFinance_Commercial_Finance_FINAL.pbit) · [final_v1 data contract](powerbi/data/final_v1/README.md) · [build QA](reports/POWER_BI_FINAL_BUILD_QA_2026-08-31.md) · [data QA](reports/POWER_BI_FINAL_V1_DATA_QA_2026-08-31.md) · [measure catalog](powerbi/final/DAX_MEASURE_CATALOG.md) · [release checklist](powerbi/final/RELEASE_CHECKLIST.md). This build has 30 tables, 88 explicit measures, 34 relationships, 11 primary pages, 4 drillthroughs and 4 tooltips at a 1,672 × 941 canvas. Native Desktop render/refresh remains an explicit external gate.
...
- [Unified finance refresh orchestrator](scripts/run_finance_refresh.py) · one evidence-producing command for Import swap, optional DirectQuery load and optional Service refresh
