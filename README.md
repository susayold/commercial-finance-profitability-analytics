...
- Current controlled finance release: **`VNFINANCE-FPA-v1.1.1`** · tag **`fpa-portfolio-v1.1.1`**
...
- [Excel FP&A Model Showcase](https://susayold.github.io/commercial-finance-profitability-analytics/excel/) — **12-sheet recruiter workbook v1.2.0**
...
The public recruiter workbook is a compact Excel proof-of-skill companion to the governed finance case. It is designed around professional spreadsheet principles: clear purpose and audience, separated inputs/workings/outputs/controls, documented assumptions, consistent formulas, review checks and version history.

**Workbook:** `VietNova_FPA_Commercial_Finance_Excel_Model_v1.2.0.xlsx`  
**Sheets:** 12  
**Macros:** none  
**Evidence:** simulated / derived portfolio data  
**Historical forecast evidence:** `SIMULATED_HISTORICAL_BACKTEST`  
**Live forecast accuracy:** Gate A remains OPEN by design.

The workbook demonstrates:

- controlled hardcoded assumptions and formula-driven outputs;
- cross-sheet financial modelling and management P&L logic;
- Actual / Budget / Forecast variance analysis;
- `SUMIFS`-based commercial/channel analysis and contribution-margin hurdle logic;
- working-capital formulas for AR, inventory, AP and CCC;
- data-validation scenario selectors with `INDEX` / `MATCH` logic;
- forecast Bias / WAPE review using the governed historical OOS results;
- cost-variance and inventory review;
- model checks, PASS / OPEN controls and evidence boundaries;
- dedicated version / change log for handover.

The website Excel page also explains **what was built, what was learned, and how these skills translate into monthly reporting, variance investigation, profitability analysis, working-capital monitoring, planning support and model handover.**
...
| Website Pages 1–10 | **PASS** | Every governed finance page is checked against its finance module and evidence boundary |
| Excel recruiter showcase | **AVAILABLE** | Separate Excel proof-of-skill page and downloadable 12-sheet workbook |
...
The immutable `fpa-portfolio-v1.1.1` tag remains the last controlled finance-content release. The Excel v1.2.0 artifact is an additive recruiter capability layer and does not change the FY2025 finance truth or close Gate A.
...
The recruiter website is not an independent storytelling layer. Pages 1–10 are checked against the same governed finance contracts used by the repository. The Excel showcase is a separate capability page and does not introduce a new finance truth set.
