...
The approved MCH supplement now covers FY2020–FY2025 (48 rows, all eight metrics), after visual PDF review, statement tie-outs, balance-sheet checks and cash-flow confirmation. FY2016–FY2019 remain blocked. [approved CSV](data/mch_statement_metrics_2024_2025_approved.csv) · [reconciliation report](reports/MCH_APPROVED_STATEMENT_SUPPLEMENT_2024_2025.md) · [Drive Sheet](https://docs.google.com/spreadsheets/d/1a3crr3Je3U1q7tnCMgYH--ZimJFfh7EdCmdhsKQNbz8/edit)