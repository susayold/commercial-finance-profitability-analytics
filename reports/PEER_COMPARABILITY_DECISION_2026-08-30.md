...
The MCH OCR workbench contains 59 machine-review candidates and remains a deliberately unapproved queue; the separate 80-row statement supplement was page-reviewed and approved. Implausible OCR candidates (for example FY2018 cash VND 119,982 and FY2022 cash VND 13,013) demonstrate why these rows must not enter the approved panel automatically. See `reports/MCH_OCR_REVIEW_DECISION_2026-08-30.md`.
...
MCH FY2024–FY2025 statements were the initial approved supplement; the approved layer has since been extended to FY2016–FY2025 (80 rows, all eight metrics) with visual page review, statement/balance-sheet tie-outs and cash-flow confirmation. FY2017 retains its comparative/corresponding-column caveat. See `reports/MCH_APPROVED_STATEMENT_SUPPLEMENT_2024_2025.md`, `data/mch_statement_metrics_2024_2025_approved.csv`, and Drive memo https://docs.google.com/document/d/1Ib__7FWjmtGFViexE-f__U2qCGx6xz3AK9qOTB8fLsw/edit.
