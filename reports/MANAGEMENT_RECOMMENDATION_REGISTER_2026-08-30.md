...
| REC-04 | Collect top overdue accounts before funding more growth | DSO deterioration converts a P&L win into cash pressure | Base CCC 54.0 days; Downside CCC 68.0 days | Cash release = DSO days reduced × approved daily sales | AR lead | DSO ≤ Base + 5 days | PROXY_DERIVED | Weekly cash call |
...
| REC-06 | Keep Base as planning case; gate Upside on evidence | Upside assumes both growth and better cash conversion | Base revenue VND 82.5bn vs Upside VND 85.7bn; CCC 54.0 vs 48.0 days | Incremental contribution − incremental risk/cash | FP&A lead | Two closes above CM hurdle; no service breach | PROXY_DERIVED | Forecast cycle |
