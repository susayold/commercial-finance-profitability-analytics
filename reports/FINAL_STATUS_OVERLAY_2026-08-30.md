...
| MCH FY2017 | Audited FY2018 comparative/corresponding columns remain the approved provenance; the official FY2017 PDF is now captured in a bounded 8-metric indexed evidence layer, but standalone bytes/hash are still unavailable | reports/MCH_FY2017_WEB_INDEX_EVIDENCE.md, data/mch_fy2017_web_index_evidence.csv, reports/MCH_FY2017_WEB_INDEX_EVIDENCE_QA.md |
...
| Recruiter website | Sites version 8 is deployed and includes the Operating Finance System section, MCH Finance Analyst Lens and credit-memo link | https://vn-finance-fpa-case.sangkenny200.chatgpt.site; V8 release record: https://drive.google.com/file/d/1p3gSEo7gkH_skLniiMFK96SgBnk1aSaO/view?usp=drivesdk |
...
The official FY2017 and FY2020 annual-report URLs are accompanied by a detailed [source-verification runbook](../docs/MCH_SOURCE_VERIFICATION_RUNBOOK_2026-08-30.md) and Drive mirror (https://docs.google.com/document/d/1dQLpARQ3nV4qkt4DbFU4yCVVHQ7zSYO7rH-8c9C-Xtk/edit?usp=drivesdk). FY2020 bytes are archived from the official HNX signed PDF, page-reviewed and classified `APPROVED` with hash/size and statement anchors recorded. The official Masan Consumer FY2017 annual-report PDF is linked and indexed by the company site, and the eight extracted metrics are preserved in [the indexed evidence memo](MCH_FY2017_WEB_INDEX_EVIDENCE.md) and [CSV](../data/mch_fy2017_web_index_evidence.csv), with [QA](MCH_FY2017_WEB_INDEX_EVIDENCE_QA.md) at 8/8 PASS. FY2017 remains `INDEXED_ONLY` until standalone PDF bytes and hash are archived; the approved FY2016–FY2025 supplement and FY2017 comparative provenance are unchanged.
...
Operational driver tree automated QA: local validator PASS (15/15); latest GitHub Finance model QA run 697 PASS (including CAPEX/OPEX and PBIP coherence): https://github.com/susayold/commercial-finance-profitability-analytics/actions/runs/33299199960
