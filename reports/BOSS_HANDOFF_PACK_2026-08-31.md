...
| Active no-Power-BI execution plan | [GitHub plan](https://github.com/susayold/commercial-finance-profitability-analytics/blob/main/docs/VNFINANCE_FPA_ACTIVE_EXECUTION_PLAN_NO_POWERBI_2026-09-02.md) · [Drive plan](https://drive.google.com/file/d/1jAQi6s4DJ8hTCnbJYRavu5kJWeHqmvf3/view?usp=drivesdk) | Current scope, acceptance criteria and remaining input gates |
...
6. **Candidate profile:** open the [one-page CV PDF](https://drive.google.com/file/d/1Gm2kGAoktzWA-DDakfrzo_-sL1sL9jax/view?usp=drivesdk), [candidate-facts intake](https://drive.google.com/file/d/1Vw2cdUYwIaBS4Sj0z5F1eVNnzFLHbj5T/view?usp=drivesdk) and [one-page FP&A case summary](https://drive.google.com/file/d/19rzyxjeIWWDus1LzPiYzcvtM3yK3yxkO/view?usp=drivesdk).
...
| Portfolio and CV | Recruiter site, finance-first CV PDF and interview narrative | **Structurally complete** — personal facts and recording remain input-gated before submission |
...
- The current release is reproducible from the GitHub commit shown in the manifest; the Drive handoff files are synced to the same non-BI evidence set.
- **Gate A open:** a genuine internal forecast/budget snapshot is still required to claim real-company forecast accuracy.
- **Walkthrough recording handoff:** the five-minute script, editable deck and machine-readable handoff contract are complete; recording URL, hash and reviewer sign-off remain blank until the candidate records it.
...
github_commit=6d1819c410519f83ff8ba93a4c7854339734aba5
...
live_site_version=26
core_non_bi_qa=55/55
release_file_gate=52/52
recruiter_link_qa=42/42
power_bi_status=ARCHIVED_OUT_OF_ACTIVE_SCOPE
```
