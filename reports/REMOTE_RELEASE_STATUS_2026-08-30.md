...
- Block A now has a structured approval register (`data/block_a_design_lock.csv`) and validator (`scripts/validate_block_a_design_lock.mjs`); all 20 rows are `PROPOSED` until candidate approval, with audit fields enforced for any later status change.
- Structured Block A register is archived as [CSV](../data/block_a_design_lock.csv), [validator](../scripts/validate_block_a_design_lock.mjs) and [QA](BLOCK_A_DESIGN_LOCK_QA.md); Drive copies: [CSV](https://drive.google.com/file/d/1wddKz1OXWyfh_VDvm92U81GoHuKOJa1u/view?usp=drivesdk), [validator](https://drive.google.com/file/d/1T5e5a4ikY_apTT_abFEaG63NWWyitKJs/view?usp=drivesdk), [QA](https://drive.google.com/file/d/1CdM3_uCP5wf6Fw-fGYj6qfhkiY-Qwl16/view?usp=drivesdk).

- Liquidity stress is now independently inspectable: [methodology](../docs/LIQUIDITY_STRESS_METHODOLOGY.md), [synthetic schedule](../data/liquidity_stress_synthetic.csv), [validator](../scripts/validate_liquidity_stress.mjs), [QA 9/9](LIQUIDITY_STRESS_QA.md), with Drive mirrors [schedule](https://drive.google.com/file/d/1WLVSFiwDsRcySK-_E3_wFxpJpvTOec8I/view?usp=drivesdk), [methodology](https://drive.google.com/file/d/1YHE1Y3x-AdblXZumk9QBztbUwwxGHcEf/view?usp=drivesdk), [validator](https://drive.google.com/file/d/1P45NxJoee3U_nZbKwbYE_2hiCdiILTVN/view?usp=drivesdk), [QA](https://drive.google.com/file/d/1xjKSAh22zFGbgUIT3foYe-NbjAMmJS7t/view?usp=drivesdk). The downside case reaches the revolver limit in October and ends December with negative VND740m headroom; this is synthetic rehearsal evidence.

- Inventory quality is now independently inspectable: [methodology](../docs/INVENTORY_QUALITY_METHODOLOGY.md), [36-row synthetic schedule](../data/inventory_quality_synthetic.csv), [validator](../scripts/validate_inventory_quality.mjs) and [QA 9/9](INVENTORY_QUALITY_QA.md). Drive mirrors: [schedule](https://drive.google.com/file/d/1PvM1CCVqGh6kDiftBQyzfHAz0kCphRTi/view?usp=drivesdk), [methodology](https://drive.google.com/file/d/1v9mT08eADR_WtldPwKwwLGu_2UUZ0dON/view?usp=drivesdk), [validator](https://drive.google.com/file/d/1BqPUA4HrRqft33qyIaZQZJUqs-jBGBQ1/view?usp=drivesdk), [QA](https://drive.google.com/file/d/1CH3oTWcKdQAWY8bowHsOYfHK8Pmd7NFW/view?usp=drivesdk).

- Customer profitability is now independently inspectable: [methodology](../docs/CUSTOMER_PROFITABILITY_METHODOLOGY.md), [24-row synthetic customer P&L](../data/customer_profitability_synthetic.csv), [validator](../scripts/validate_customer_profitability.mjs) and [QA 10/10](CUSTOMER_PROFITABILITY_QA.md). C06 is deliberately a high-revenue / low-margin / long-DSO review account; all values are synthetic rehearsal evidence. Drive mirrors: [P&L](https://drive.google.com/file/d/1S9zo-2x90wd3kHCQE-3HnKgzXf7EiQs4/view?usp=drivesdk), [methodology](https://drive.google.com/file/d/1-fX1ha3FRjueADxB6JKwoJVHUOySauZ9/view?usp=drivesdk), [validator](https://drive.google.com/file/d/1aVU-W46JXXZ6_ZgnPpBQxzE-QYIab3th/view?usp=drivesdk), [QA](https://drive.google.com/file/d/18F5b6jsL8MMppfDfqu7VIe7zM8owYqnX/view?usp=drivesdk).

- Latest CI confirmation: [run #762](https://github.com/susayold/commercial-finance-profitability-analytics/actions/runs/33301559885) passed after the customer working-capital overlay validator was corrected to allow the documented VND million rounding convention. The runner remains 24 total checks (23 repository-local validators plus contract-shape). Drive mirrors and the DoD audit now include the customer module.
...
- External gate readiness is now machine-readable: [readiness report](../reports/EXTERNAL_GATE_READINESS.md), [JSON](../data/external_gate_readiness.json) and [10/10 QA](../reports/EXTERNAL_GATE_READINESS_QA.md). Drive mirrors: [report](https://drive.google.com/file/d/19va7iv_Y2VqruqEtAIID2ptogyMXZWvF/view?usp=drivesdk), [JSON](https://drive.google.com/file/d/1v4FUyvjqmO7Iw1F8FCS-ebwKf43OcFTe/view?usp=drivesdk), [validator](https://drive.google.com/file/d/18F8TCP1VYCj0IeHKaNo0eZd2lpRVqTYT/view?usp=drivesdk), [QA](https://drive.google.com/file/d/1MBAe9s2geemTe1F9MmoX266TVAarfcxz/view?usp=drivesdk). It records Gate A/B as pending external evidence without enabling production claims.
