...
| Ephemeral instance | `VNFinanceDQ_SMOKE_20260830190532` (deleted) |
| First batch | `DQ_LOCALDB_TWO_BATCH_BASE_20260830T190532Z` |
| Second batch | `DQ_LOCALDB_TWO_BATCH_CHANGED_20260830T190532Z` |
| Physical tables | 14 |
...
| Health query after second commit | 0.0130 seconds (first sample) on LocalDB |
| Health query latency benchmark | **20 samples**; p50 `0.0132s`, p95 `0.0153s`, min `0.0118s`, max `0.0153s`; every sample exposed the changed `PASS` batch |
