...
| Ephemeral instance | `VNFinanceDQ_SMOKE_20260830183813` (deleted) |
| First batch | `DQ_LOCALDB_TWO_BATCH_BASE_20260830T183813Z` |
| Second batch | `DQ_LOCALDB_TWO_BATCH_CHANGED_20260830T183813Z` |
| Physical tables | 14 |
...
| Health query after second commit | 0.0134 seconds (first sample) on LocalDB |
| Health query latency benchmark | **20 samples**; p50 `0.0135s`, p95 `0.0156s`, min `0.0112s`, max `0.0172s`; every sample exposed the changed `PASS` batch |
