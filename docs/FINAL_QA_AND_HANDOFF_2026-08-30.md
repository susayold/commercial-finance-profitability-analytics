...
Automated QA evidence: operational driver validator PASS (15/15) locally; latest GitHub Finance model QA run 638 is PASS and includes CAPEX/OPEX plus PBIP source coherence: https://github.com/susayold/commercial-finance-profitability-analytics/actions/runs/33295105470
