...
2. **Medium — historical peer extraction is not fully approved.** The 25-row queue in `Peer_Extraction_Queue` covers VNM FY2006–2020, QNS FY2016–2020 and KDC FY2016–2020. Rows are intentionally labelled `statement_review_required` until page-level anchors and restated comparatives are captured.
